...
在阶段1/2/3 CSV 生成后运行，输出 Markdown 报告到 experiment_results/v7_analysis.md。

Usage:
    python user_data/scripts/analyze_v7.py
...
RESULTS_CSV = os.path.join(BASE, "user_data", "experiment_results", "v7_results.csv")
YEARLY_CSV = os.path.join(BASE, "user_data", "experiment_results", "v7_yearly.csv")
WALKFORWARD_CSV = os.path.join(BASE, "user_data", "experiment_results", "v7_walkforward.csv")
REPORT_MD = os.path.join(BASE, "user_data", "experiment_results", "v7_analysis.md")
