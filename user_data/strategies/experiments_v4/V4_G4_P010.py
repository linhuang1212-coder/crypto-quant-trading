"""V4 G4 1H 1h_and_4h adx>25 stair=False"""
...
class V4_G4_P010(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_conditions = (
            ...
            ((((dataframe['ema21_1h'] > dataframe['ema55_1h']) & (dataframe['ema21_4h'] > dataframe['ema55_4h'])) & (dataframe['adx_1h'] > self.H1_ADX_MIN)))
        )
