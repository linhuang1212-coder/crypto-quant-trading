"""V4 G9 hybrid ex0_4_allow8_20 stair=False"""
...
class V4_G9_P020(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_conditions = (
            ...
            (((~dataframe['hour'].between(0, 3, inclusive='both')) & (dataframe['hour'].between(8, 19, inclusive='both'))))
        )
