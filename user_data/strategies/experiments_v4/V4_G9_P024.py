"""V4 G9 hybrid ex8_12_allow0_12 stair=False"""
...
class V4_G9_P024(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_conditions = (
            ...
            (((~dataframe['hour'].between(8, 11, inclusive='both')) & (dataframe['hour'].between(0, 11, inclusive='both'))))
        )
