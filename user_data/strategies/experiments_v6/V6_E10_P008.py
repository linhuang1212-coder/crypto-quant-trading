"""V6 E10 stair TP tp1=0.08/0.03 tp2=0.15/0.08 tp3=0.4"""
...
class V6_E10_P008(IStrategy):
    ...
    def custom_exit(self, pair, trade, current_time, current_rate, current_profit, **kwargs):
        ...
        if max_profit >= 0.4 and current_profit < max_profit * 0.5:
            return "stair_tp3"
        if max_profit >= 0.15 and current_profit < 0.08:
            return "stair_tp2"
        if max_profit >= 0.08 and current_profit < 0.03:
            return "stair_tp1"
