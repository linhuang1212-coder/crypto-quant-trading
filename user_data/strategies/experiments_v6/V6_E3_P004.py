"""V6 E3 pullback lb=3 prox=0.5 macd=False"""
...
class V6_E3_P004(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['broke_above'] = (dataframe['high'].rolling(3).max() > dataframe['dc_upper']).astype(int)
        dataframe['near_dc'] = ((dataframe['close'] - dataframe['dc_upper']).abs() < dataframe['atr'] * 0.5).astype(int)
        return dataframe
