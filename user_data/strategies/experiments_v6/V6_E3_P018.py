"""V6 E3 pullback lb=8 prox=0.8 macd=False"""
...
class V6_E3_P018(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['near_dc'] = ((dataframe['close'] - dataframe['dc_upper']).abs() < dataframe['atr'] * 0.8).astype(int)
        return dataframe
