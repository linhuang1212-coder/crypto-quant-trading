"""V6 E6 MTF DC 4H dc=30 breakout=True atr=0.3"""
...
class V6_E6_P014(IStrategy):
    ...
    def populate_indicators_4h(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['dc_upper_4h'] = dataframe['high'].rolling(30).max().shift(1)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_conditions = (
            ...
            (dataframe['close'] > dataframe['dc_upper_4h_4h']) & ((dataframe['close'] - dataframe['dc_upper_4h_4h']) > dataframe['atr_4h_4h'] * 0.3) &
