"""V6 E7 dynamic ATR_MULT low=0.3 high=0.8 th=0.7"""
...
class V6_E7_P003(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['dyn_atr_mult'] = np.where(dataframe['atr_pct'] < 0.7, 0.3, 0.8)
        return dataframe
