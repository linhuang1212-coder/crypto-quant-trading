"""V6 E7 dynamic ATR_MULT low=0.3 high=1.0 th=0.8"""
...
class V6_E7_P012(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['dyn_atr_mult'] = np.where(dataframe['atr_pct'] < 0.8, 0.3, 1.0)
        return dataframe
