"""V7 G11 dynamic timeout loss=40 win=80 th=-0.02"""
...
class V7_G11_P003(IStrategy):
    ...
    def custom_exit(self, pair, trade, current_time, current_rate, current_profit, **kwargs):
        ...
        if bars_held >= 20 and current_profit < -0.06:
            return "stair_mid"
        if bars_held >= 40 and current_profit < -0.02:
            return "timeout_loss_dyn"
        if bars_held >= 80 and current_profit < 0.01:
