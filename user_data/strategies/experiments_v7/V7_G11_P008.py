"""V7 G11 dynamic timeout loss=24 win=64 th=-0.03"""
...
class V7_G11_P008(IStrategy):
    ...
    def custom_exit(self, pair, trade, current_time, current_rate, current_profit, **kwargs):
        ...
        if bars_held >= 20 and current_profit < -0.06:
            return "stair_mid"
        if bars_held >= 24 and current_profit < -0.03:
            return "timeout_loss_dyn"
        if bars_held >= 64 and current_profit < 0.01:
