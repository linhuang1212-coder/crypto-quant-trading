"""V7 G13 compound exit di=True ema=True adx=True bars=16"""
    ...
    def custom_exit(self, pair, trade, current_time, current_rate, current_profit, **kwargs):
        ...
        if bars_held >= 16:
            ...
            if len(dataframe) >= 3:
                ...
                if last['minus_di'] > last['plus_di'] and last['ema21'] < last['ema55'] and last['adx'] < dataframe['adx'].iloc[-3]:
