"""V7 G4 Keltner kp=30 km=2.5 macd=False"""
...
class V7_G4_P012(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        kc_mid = ta.EMA(dataframe, timeperiod=30)
        kc_atr = ta.ATR(dataframe, timeperiod=30)
        dataframe['kc_upper'] = kc_mid + 2.5 * kc_atr
        dataframe['kc_lower'] = kc_mid - 2.5 * kc_atr
