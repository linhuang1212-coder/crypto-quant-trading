"""V7 G8 MACD threshold=0.001 rising=True"""
...
class V7_G8_P003(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_conditions = (
            ...
            (dataframe['macdhist'] > 0.001) & (dataframe['macdhist'] > dataframe['macdhist'].shift(1))
        )
