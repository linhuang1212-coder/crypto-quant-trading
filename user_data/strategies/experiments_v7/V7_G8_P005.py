"""V7 G8 MACD threshold=0.005 rising=True"""
...
class V7_G8_P005(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_conditions = (
            ...
            (dataframe['macdhist'] > 0.005) & (dataframe['macdhist'] > dataframe['macdhist'].shift(1))
        )
