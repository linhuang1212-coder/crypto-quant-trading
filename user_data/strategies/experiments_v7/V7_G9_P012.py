"""V7 G9 session=overlap macd=False"""
...
class V7_G9_P012(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_conditions = (
            ...
            ((dataframe['date'].dt.hour >= 13) & (dataframe['date'].dt.hour < 17))
        )
        dataframe.loc[long_conditions, 'enter_long'] = 1
        dataframe.loc[long_conditions, 'enter_tag'] = 'dc_overlap'
        return dataframe
